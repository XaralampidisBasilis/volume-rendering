...
#include "./debug_trace/debug_trace_error"              
#include "./debug_trace/debug_trace_abs_error"          
...
{ 
    ...
    case  4: fragColor = debug.trace_distance;            break;
    case  5: fragColor = debug.trace_outside;             break;
    case  6: fragColor = debug.trace_position;            break;
    case  7: fragColor = debug.trace_error;               break;
    case  8: fragColor = debug.trace_abs_error;           break;
    case  9: fragColor = debug.trace_derivative;          break;
    case 10: fragColor = debug.trace_step_distance;       break;
    case 11: fragColor = debug.trace_step_scaling;        break;
    case 12: fragColor = debug.trace_step_count;          break;
    case 13: fragColor = debug.trace_mean_step_scaling;   break;
    case 14: fragColor = debug.trace_mean_step_distance;  break;
    case 15: fragColor = debug.trace_stepped_distance;    break;
    case 16: fragColor = debug.trace_skipped_distance;    break;
    case 17: fragColor = debug.trace_spanned_distance;    break;
}