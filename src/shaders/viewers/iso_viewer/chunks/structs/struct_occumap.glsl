...
struct Occumap
{
    ...
    ivec3 block_coords;
    vec3  block_texture_coords;
    float block_occupancy;
    bool  block_occupied;
};
...
Occumap set_occumap()
{
    ...
    occumap.block_coords         = ivec3(0);
    occumap.block_texture_coords = vec3(0.0);
    occumap.block_occupancy      = 0.0;
    occumap.block_occupied       = false;
    return occumap;
}
