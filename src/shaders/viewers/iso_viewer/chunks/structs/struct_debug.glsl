...
struct Debug 
{
    ...
    vec4 trace_min_step_stretching;
    vec4 trace_max_step_stretching;
    vec4 trace_range_step_stretching;
...
Debug set_debug()
{
    ...
    debug.trace_sample_abs_error      = vec4(vec3(0.0), 1.0);
    debug.trace_sample_error          = vec4(vec3(0.0), 1.0);
    debug.trace_sample_value          = vec4(vec3(0.0), 1.0);
    ...
    debug.trace_min_step_stretching   = vec4(vec3(0.0), 1.0);
    debug.trace_max_step_stretching   = vec4(vec3(0.0), 1.0);
    debug.trace_range_step_stretching = vec4(vec3(0.0), 1.0);
