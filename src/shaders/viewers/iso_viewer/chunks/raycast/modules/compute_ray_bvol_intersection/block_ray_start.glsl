...
block.min_position = (vec3(block.min_coords + 0) - MILLI_TOLERANCE) * u_distmap.spacing;
block.max_position = (vec3(block.max_coords + 1) + MILLI_TOLERANCE) * u_distmap.spacing;
