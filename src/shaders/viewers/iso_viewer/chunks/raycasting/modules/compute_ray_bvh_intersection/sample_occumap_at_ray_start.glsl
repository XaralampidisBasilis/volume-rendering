...
occumap.block_occupancy = texelFetch(u_textures.occumaps, occumaps_coords, 0).r; // faster but less accurate
// occumap.block_occupancy = textureLod(u_textures.occumaps, occumaps_texture_coords, 0.0).r; // slower but more accurate
