...
float ray_regress_distance = intersect_box_max(block_min_position, block_max_position, ray.start_position, -ray.step_direction);
ray_regress_distance += u_volume.spacing_length * 2.0;  

// updata ray start distance and position
ray.start_distance -= ray_regress_distance;
