 ...
 * @input raymarch.min_step_scaling : The minimum allowable step scaling factor (float)
 * @input raymarch.max_step_scaling : The maximum allowable step scaling factor (float)
 *
