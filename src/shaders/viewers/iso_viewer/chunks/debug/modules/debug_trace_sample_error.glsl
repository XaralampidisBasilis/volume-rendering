...
vec3 debug_trace_sample_error_mapped_color = texture(textures.colormaps, debug_trace_sample_error_colormap_coords).rgb;

debug.trace_sample_error = vec4(debug_trace_sample_error_mapped_color, 1.0);
