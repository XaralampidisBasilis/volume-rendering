...
float trace_gradient_norm_normalized = trace.gradient_norm / u_gradient.max_norm;
...
debug.trace_gradient_norm = vec4(vec3(trace_gradient_norm_normalized * u_debug.scale), 1.0);
