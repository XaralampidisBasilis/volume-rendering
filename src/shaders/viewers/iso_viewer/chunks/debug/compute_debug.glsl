...
switch (debugging.option)
{
    ...
    case 19: fragColor = debug.trace_distance_error;     break;
    case 20: fragColor = debug.trace_distance_diff;      break;
    case 21: fragColor = debug.trace_gradient_magnitude; break;
    case 22: fragColor = debug.trace_gradient;           break;
    case 23: fragColor = debug.trace_luminance;          break;
    case 24: fragColor = debug.trace_mapped_color;       break;
    case 25: fragColor = debug.trace_mean_step_distance; break;
    case 26: fragColor = debug.trace_normal;             break;
    case 27: fragColor = debug.trace_outside;            break;
    case 28: fragColor = debug.trace_position;           break;
    case 29: fragColor = debug.trace_sample_abs_error;   break;
    case 30: fragColor = debug.trace_sample_error;       break;
    case 31: fragColor = debug.trace_sample_value;       break;
    case 32: fragColor = debug.trace_shaded_color;       break;
    case 33: fragColor = debug.trace_skip_count;         break;
    case 34: fragColor = debug.trace_skip_distance;      break;
    case 35: fragColor = debug.trace_skipped_distance;   break;
    case 36: fragColor = debug.trace_spanned_distance;   break;
    case 37: fragColor = debug.trace_step_count;         break;
    case 38: fragColor = debug.trace_step_distance;      break;
    case 39: fragColor = debug.trace_step_scaling;       break;
    case 40: fragColor = debug.trace_stepped_distance;   break;
    case 41: fragColor = debug.trace_voxel_coords;       break;
    case 42: fragColor = debug.trace_total_count;        break;
    case 43: fragColor = debug.variable1;                break;
    case 44: fragColor = debug.variable2;                break;
    case 45: fragColor = debug.variable3;                break;
}
