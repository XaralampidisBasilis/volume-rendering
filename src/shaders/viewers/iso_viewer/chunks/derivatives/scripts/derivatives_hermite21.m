...
P1_x = simplify(subs(P1_x, [a0 a1 a2 b1], [sol.a0, sol.a1, sol.a2, sol.b1]));
P2_x = simplify(subs(P2_x, [a0 a1 a2 b1], [sol.a0, sol.a1, sol.a2, sol.b1]));
P3_x = simplify(subs(P3_x, [a0 a1 a2 b1], [sol.a0, sol.a1, sol.a2, sol.b1]));
N0_x = simplify(subs(N0_x, [a0 a1 a2 b1], [sol.a0, sol.a1, sol.a2, sol.b1]));
N1_x = simplify(subs(N1_x, [a0 a1 a2 b1], [sol.a0, sol.a1, sol.a2, sol.b1]));
N2_x = simplify(subs(N2_x, [a0 a1 a2 b1], [sol.a0, sol.a1, sol.a2, sol.b1]));
N3_x = simplify(subs(N3_x, [a0 a1 a2 b1], [sol.a0, sol.a1, sol.a2, sol.b1]));
D0_x = simplify(subs(D0_x, [a0 a1 a2 b1], [sol.a0, sol.a1, sol.a2, sol.b1]));
D1_x = simplify(subs(D1_x, [a0 a1 a2 b1], [sol.a0, sol.a1, sol.a2, sol.b1]));
D2_x = simplify(subs(D2_x, [a0 a1 a2 b1], [sol.a0, sol.a1, sol.a2, sol.b1]));
D3_x = simplify(subs(D3_x, [a0 a1 a2 b1], [sol.a0, sol.a1, sol.a2, sol.b1]));
