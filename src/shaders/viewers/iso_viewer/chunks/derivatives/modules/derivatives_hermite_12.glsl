...
vec2 trace_speed = vec2(trace_prev.sample_value, trace.sample_value) / trace.step_distance;
...
ratios /= trace_slope * trace.sample_value - trace_prev.derivative_1st * trace_prev.sample_value;

// recursive formulas
trace.derivative_2nd = 2.0 * ratios.x * trace.derivative_1st - 2.0 * ratios.y * trace.sample_value;
