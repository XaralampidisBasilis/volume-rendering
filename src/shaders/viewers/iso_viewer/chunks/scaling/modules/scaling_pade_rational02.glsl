...
next_stepping = mix(vec2(raymarch.max_step_scale), next_stepping, greaterThan(next_stepping, vec2(0.0)));
next_stepping = mix(vec2(raymarch.max_step_scale), next_stepping, bvec2(num_roots > 0));
