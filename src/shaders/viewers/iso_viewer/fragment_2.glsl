...
#include ../../includes/raycast/raycast_fast.glsl;
...
void main() 
{
    ...
    bool ray_hit = raycast_fast(u_raycast, u_volume, u_occupancy, u_sampler_volume, u_sampler_occupancy, v_camera, ray_normal, hit_position, hit_intensity);
