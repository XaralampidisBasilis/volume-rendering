...
float trace_mapped_value = map(u_colormap.thresholds.x, u_colormap.thresholds.y, trace.max_sample_value);
...
// trace.mapped_color.a = trace.max_sample_value / u_raymarch.max_sample_value;
