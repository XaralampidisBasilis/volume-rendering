...
float debug_trace_distance_error = trace.distance - dot(trace.position - ray.camera_position, ray.step_direction);
debug_trace_distance_error = map(-1.0, 1.0, debug_trace_distance_error / MICRO_TOLERANCE);
