...
{ 
    case  1: fragColor = debug.trace_terminated;          break;
    case  2: fragColor = debug.trace_exhausted;           break;
    case  3: fragColor = debug.trace_distance;            break;
    case  4: fragColor = debug.trace_outside;             break;
    case  5: fragColor = debug.trace_position;            break;
    case  6: fragColor = debug.trace_error;               break;
    case  7: fragColor = debug.trace_abs_error;           break;
    case  8: fragColor = debug.trace_derivative;          break;
    case  9: fragColor = debug.trace_step_distance;       break;
    case 10: fragColor = debug.trace_step_scaling;        break;
    case 11: fragColor = debug.trace_step_count;          break;
    case 12: fragColor = debug.trace_mean_step_scaling;   break;
    case 13: fragColor = debug.trace_mean_step_distance;  break;
