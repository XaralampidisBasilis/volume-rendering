syms x t g s p q a0 a1 a2 a3 a4 b0 b1 
assume([x t g s p q a0 a1 a2 a3 a4 b0 b1], 'real')
...
f_x = (a4*x^4 + a3*x^3 + a2*x^2 + a1*x + a0) / (x^2 + b1*x + b0);
...
sol = solve([eq1, eq2, eq3, eq4, eq5], [a0 a1 a2 a3 a4], 'ReturnConditions', true);

s_x  = simplify(subs(f_x,  [a0 a1 a2 a3 b0], [sol.a0, sol.a1, sol.a2, sol.a3, sol.a4]));
s1_x = simplify(subs(f1_x, [a0 a1 a2 a3 b0], [sol.a0, sol.a1, sol.a2, sol.a3, sol.a4]));
s2_x = simplify(subs(f2_x, [a0 a1 a2 a3 b0], [sol.a0, sol.a1, sol.a2, sol.a3, sol.a4]));
