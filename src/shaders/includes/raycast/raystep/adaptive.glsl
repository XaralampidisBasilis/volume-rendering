 ...
 */
vec3 adaptive(in uniforms_raycast u_raycast, in uniforms_volume u_volume, in vec3 ray_normal, in vec3 ray_position, float min_step, float max_step, float density_threshold) 
{
