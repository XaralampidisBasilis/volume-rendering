 ...
 */
vec3 adaptive(in raycast_uniforms u_raycast, in volume_uniforms u_volume, in vec3 ray_normal, in vec3 ray_position, float min_step, float max_step, float density_threshold) 
{
