 ...
 */
vec3 phong_blin(in lighting_uniforms u_lighting, in vec3 color, in vec3 normal_vector, in vec3 surface_position, in vec3 view_position, in vec3 source_position)
{
