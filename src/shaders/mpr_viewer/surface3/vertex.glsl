...
void main() {				    
    ...
    v_origin = camera_position.xyz * u_volume.inv_spacing; // camera position in grid coordinates

    // vertex position varying
    v_position = position * u_volume.inv_spacing; // vertex position in grid coordinates
