...
vec3 bbox_min_position = u_intensity_map.min_position;
vec3 bbox_max_position = u_intensity_map.max_position;

// shrink volume bounding box by a small amount to avoid numerical instabilities in the boundary
bbox_min_position += u_intensity_map.spacing * MILLI_TOLERANCE;
bbox_max_position -= u_intensity_map.spacing * MILLI_TOLERANCE;
