...
export default function()
{
    const uniforms = {
        ...
        u_raycast_refinements:  new THREE.Uniform(3),   
        u_raycast_resolution:   new THREE.Uniform(0.25),   
        u_raycast_dithering:    new THREE.Uniform(true),   

        u_gradient_method:      new THREE.Uniform(1),      
        u_gradient_resolution:  new THREE.Uniform(1),      
        ...
        u_occupancy_resolution: new THREE.Uniform(10),
