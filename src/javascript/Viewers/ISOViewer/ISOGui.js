    ...
    addControllersDebug()
    {
        ...
        this.controllers.debug = 
        {
            option: folder.add(uniforms, 'option').options({ 
                ...
                ray_end_distance         :  3,
                ray_end_position         :  4,
                ray_max_step_count       :  5,
                ray_rand_distance        :  6,
                ray_span_distance        :  7,
                ray_start_distance       :  8,
                ray_start_position       :  9,
                ray_step_direction       : 10,
                ray_step_distance        : 11,
                trace_block_coords       : 12,
                trace_block_lod          : 13,
                trace_block_occupancy    : 14,
                trace_block_occupied     : 15,
                trace_derivative_1st     : 16,
                trace_derivative_2nd     : 17,
                trace_derivative_3rd     : 18,
                trace_distance           : 19,
                trace_distance_error     : 20,
                trace_distance_diff      : 21,
                trace_gradient_magnitude : 22,
                trace_gradient           : 23,
                trace_luminance          : 24,
                trace_mapped_color       : 25,
                trace_mean_step_distance : 26,
                trace_normal             : 27,
                trace_outside            : 28,
                trace_position           : 29,
                trace_sample_abs_error   : 30,
                trace_sample_error       : 31,
                trace_sample_value       : 32,
                trace_shaded_color       : 33,
                trace_skip_count         : 34,
                trace_skip_distance      : 35,
                trace_skipped_distance   : 36,
                trace_spanned_distance   : 37,
                trace_step_count         : 38,
                trace_step_distance      : 39,
                trace_step_scaling       : 40,
                trace_stepped_distance   : 41,
                trace_voxel_coords       : 42,
                trace_total_count        : 43,
                debug_variable1          : 44,
                debug_variable2          : 45,
                debug_variable3          : 46,
            }),
