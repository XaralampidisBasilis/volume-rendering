    ...
    addControllersDebug()
    {
        ...
        this.controllers.debug = 
        {
            option: folder.add(uniforms, 'option').options({ 
                ...
                trace_derivative_1st    : 26,
                trace_derivative_2nd    : 27,
                trace_derivative_3rd    : 28,
                trace_outside           : 29,
                trace_position          : 30,
                trace_distance          : 31,
                trace_distance_error    : 32,
                trace_distance_diff     : 33,
                trace_block_coords      : 34,
                trace_voxel_coords      : 35,
                trace_skip_distance     : 36,
                trace_step_scaling      : 37,
                trace_step_stretching   : 38,
                ...
                trace_block_lod         : 47,
                trace_block_occupancy   : 48,
                trace_block_occupied    : 49,
                trace_mapped_color      : 50,
                trace_luminance         : 51,
                trace_shaded_color      : 52,
                variable1               : 53,
                variable2               : 54,
                variable3               : 55,
            }),
