    ...
    addControllersDebug()
    {
        ...
        this.controllers.debug = 
        {
            option: folder.add(uniforms, 'option').options({ 
                ...
                ray_end_distance         :  2,
                ray_end_position         :  3,
                ray_max_step_count       :  4,
                ray_rand_distance        :  5,
                ray_span_distance        :  6,
                ray_start_distance       :  7,
                ray_start_position       :  8,
                ray_step_direction       :  9,
                ...
                trace_distance           : 18,
                trace_distance_error     : 19,
                trace_distance_diff      : 20,
                trace_gradient_magnitude : 21,
                trace_gradient           : 22,
                trace_luminance          : 23,
                trace_mapped_color       : 24,
                trace_mean_step_distance : 25,
                trace_normal             : 26,
                trace_outside            : 27,
                trace_position           : 28,
                trace_sample_abs_error   : 29,
                trace_sample_error       : 30,
                trace_sample_value       : 31,
                trace_shaded_color       : 32,
                trace_skip_count         : 33,
                trace_skip_distance      : 34,
                trace_skipped_distance   : 35,
                trace_spanned_distance   : 36,
                trace_step_count         : 37,
                trace_step_distance      : 38,
                trace_step_scaling       : 39,
                trace_stepped_distance   : 40,
                trace_voxel_coords       : 41,
                trace_total_count        : 42,
                debug_variable1          : 43,
                debug_variable2          : 44,
                debug_variable3          : 45,
            }),
