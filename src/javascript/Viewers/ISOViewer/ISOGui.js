    ...
    addControllersDebug()
    {
        ...
        this.controllers.debug = 
        {
            option: folder.add(uniforms, 'option').options({ 
                ...
                trace_sample_value      : 18,
                trace_sample_error      : 19,
                trace_sample_abs_error  : 20,
                trace_normal            : 21,
                trace_gradient          : 22,
                trace_gradient_magnitude: 23,
                trace_derivative_1st    : 24,
                trace_derivative_2nd    : 25,
                trace_derivative_3rd    : 26,
                trace_outside           : 27,
                trace_position          : 28,
                trace_distance          : 29,
                trace_distance_error    : 30,
                trace_distance_diff     : 31,
                trace_block_coords      : 32,
                trace_voxel_coords      : 33,
                trace_skip_distance     : 34,
                trace_step_scaling      : 35,
                trace_step_distance     : 36,
                trace_mean_step_distance: 37,
                trace_spanned_distance  : 38,
                trace_stepped_distance  : 39,
                trace_skipped_distance  : 40,
                trace_step_count        : 41,
                trace_skip_count        : 42,
                trace_total_count       : 43,
                trace_block_lod         : 44,
                trace_block_occupancy   : 45,
                trace_block_occupied    : 46,
