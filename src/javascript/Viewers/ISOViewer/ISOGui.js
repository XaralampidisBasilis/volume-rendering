    ...
    addControllersDebug()
    {
        ...
        this.controllers.debug = 
        {
            option: folder.add(uniforms, 'option').options({ 
                ...
                trace_intersected       : 19,
                trace_terminated        : 20,
                trace_suspended         : 21,
                trace_sample_value      : 22,
                trace_sample_error      : 23,
                trace_sample_abs_error  : 24,
                trace_normal            : 25,
                trace_gradient          : 26,
                trace_gradient_magnitude: 27,
                trace_derivative        : 28,
                trace_outside           : 29,
                trace_position          : 30,
                trace_distance          : 31,
                trace_distance_error    : 32,
                trace_distance_diff     : 33,
                trace_voxel_coords      : 34,
                trace_skip_distance     : 35,
                trace_step_scaling      : 36,
                trace_step_stretching   : 37,
                trace_step_distance     : 38,
                trace_mean_step_scaling : 39,
                trace_mean_step_distance: 40,
                trace_spanned_distance  : 41,
                trace_stepped_distance  : 42,
                trace_skipped_distance  : 43,
                trace_step_count        : 44,
                trace_skip_count        : 45,
                trace_total_count       : 46,
                trace_mapped_color      : 47,
                trace_luminance         : 48,
                trace_shaded_color      : 49,
                occumap_lod             : 50,
                occumap_block_coords    : 51,
                occumap_block_occupancy : 52,
                occumap_block_occupied  : 53,
                variable1               : 54,
                variable2               : 55,
                variable3               : 56,
            }),
