    ...
    addControllersDebug()
    {
        ...
        this.controllers.debug = 
        {
            option: folder.add(uniforms, 'option').options({ 
                ...
                ray_step_distance       :  4,
                ray_rand_distance       :  5,
                ray_start_distance      :  6,
                ray_end_distance        :  7,
                ray_span_distance       :  8,
                ray_start_position      :  9,
                ray_end_position        : 10,
                ray_box_start_distance  : 11,
                ray_box_end_distance    : 12,
                ray_box_span_distance   : 13,
                ray_box_start_position  : 14,
                ray_box_end_position    : 15,
                ray_max_step_count      : 16,
                ray_max_skip_count      : 17,
                trace_block_coords      : 18,
                trace_block_lod         : 19,
                trace_block_occupancy   : 20,
                trace_block_occupied    : 21,
                trace_derivative_1st    : 22,
                trace_derivative_2nd    : 23,
                trace_derivative_3rd    : 24,
                trace_distance          : 25,
                trace_distance_error    : 26,
                trace_distance_diff     : 27,
                trace_gradient_magnitude: 28,
                trace_gradient          : 29,
                trace_luminance         : 30,
                trace_mapped_color      : 31,
                trace_mean_step_distance: 32,
                trace_normal            : 33,
                trace_outside           : 34,
                trace_position          : 35,
                trace_sample_abs_error  : 36,
                trace_sample_error      : 37,
                trace_sample_value      : 38,
                trace_shaded_color      : 39,
                trace_skip_count        : 40,
                trace_skip_distance     : 41,
                trace_skipped_distance  : 42,
                trace_spanned_distance  : 43,
                trace_step_count        : 44,
                trace_step_distance     : 45,
                trace_step_scaling      : 46,
                trace_stepped_distance  : 47,
                trace_voxel_coords      : 48,
                trace_total_count       : 49,
                debug_variable1         : 50,
                debug_variable2         : 51,
                debug_variable3         : 52,
            }),
            ...
            variable3         : folder.add(uniforms, 'variable3').min(-5).max(5).step(0.00000001),
