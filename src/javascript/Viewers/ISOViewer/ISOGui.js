    ...
    addControllersDebug()
    {
        ...
        this.controllers.debug = 
        {
            option: folder.add(uniforms, 'option').options({ 
                ...
                trace_mean_step_scaling : 38,
                trace_mean_step_distance: 39,
                trace_spanned_distance  : 40,
                trace_stepped_distance  : 41,
                trace_skipped_distance  : 42,
                trace_step_count        : 43,
                trace_skip_count        : 44,
                trace_total_count       : 45,
                trace_mapped_color      : 46,
                trace_luminance         : 47,
                trace_shaded_color      : 48,
                occumap_lod             : 49,
                occumap_block_coords    : 50,
                occumap_block_occupancy : 51,
                occumap_block_occupied  : 52,
                variable1               : 53,
                variable2               : 54,
                variable3               : 55,
            }),
