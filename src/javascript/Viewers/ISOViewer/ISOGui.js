    ...
    addControllersDebugging()
    {
        ...
        this.controllers.debugging = 
        {
            option: folder.add(uniforms, 'option').options({ 
                ...
                frag_shaded_color       : 21,
                frag_shaded_luminance   : 22,
                ray_discarded           : 23,
                ray_step_direction      : 24,
                ray_step_distance       : 25,
                ray_rand_distance       : 26,
                ray_start_distance      : 27,
                ray_end_distance        : 28,
                ray_span_distance       : 29,
                ray_start_position      : 30,
                ray_end_position        : 31,
                ray_max_step_count      : 32,
                ray_max_skip_count      : 33,
                trace_intersected       : 34,
                trace_terminated        : 35,
                trace_exhausted         : 36,
                trace_distance          : 37,
                trace_outside           : 38,
                ...
                trace_abs_error         : 41,
                trace_derivative        : 42,
                trace_delta_distance    : 43,
                trace_step_distance     : 44,
                trace_step_scaling      : 45,
                trace_step_stretching   : 46,
                trace_step_count        : 47,
                trace_mean_step_scaling : 48,
                trace_mean_step_distance: 49,
                trace_stepped_distance  : 50,
                trace_skipped_distance  : 51,
                trace_spanned_distance  : 52,
                voxel_coords            : 53,
                voxel_texture_coords    : 54,
                voxel_gradient          : 55,
                voxel_gradient_length   : 56,
                voxel_value             : 57,
                block_value             : 58,
                block_occupied          : 59,
                block_coords            : 60,
