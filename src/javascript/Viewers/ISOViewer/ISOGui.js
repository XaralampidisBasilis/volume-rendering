    ...
    addControllersDebug()
    {
        ...
        this.controllers.debug = 
        {
            option: folder.add(uniforms, 'option').options({ 
                ...
                trace_gradient_magnitude : 20,
                trace_gradient           : 21,
                trace_luminance          : 22,
                trace_mapped_color       : 23,
                trace_mean_step_distance : 24,
                trace_normal             : 25,
                trace_outside            : 26,
                trace_position           : 27,
                trace_sample_abs_error   : 28,
                trace_sample_error       : 29,
                trace_sample_value       : 30,
                trace_shaded_color       : 31,
                trace_skip_count         : 32,
                trace_skip_distance      : 33,
                trace_skipped_distance   : 34,
                trace_spanned_distance   : 35,
                trace_step_count         : 36,
