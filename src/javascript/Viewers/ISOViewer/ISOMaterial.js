...
export default function()
{
    ...
    const defines = 
    {
        ...
        RAY_BBOX_SKIPPING_ENABLED  : 1,
        RAY_BLOCK_SKIPPING_ENABLED : 1,

        TRACE_DITHERING_ENABLED     : 0,
        TRACE_DITHERING_METHOD      : 1,
        TRACE_STEP_SCALING_METHOD   : 10,
        TRACE_BLOCK_SKIPPING_ENABLED: 1,
        TRACE_REFINEMENT_ENABLED    : 1,
        TRACE_REFINEMENT_METHOD     : 2,
        TRACE_GRADIENTS_ENABLED     : 1,
        TRACE_GRADIENTS_METHOD      : 1,
        TRACE_SMOOTHING_ENABLED     : 1,
        TRACE_SMOOTHING_METHOD      : 1,
