    ...
    addControllersDebug()
    {
        ...
        this.controllers.debug = 
        {
            option: folder.add(uniforms, 'option').options({ 
                ...
                max_trace_sample_value      : 31,
                max_trace_mapped_color      : 32,
                max_trace_gradient          : 33,
                max_trace_gradient_magnitude: 34,
                max_trace_gradient_direction: 35,
                max_trace_derivative        : 36,
                debug_variable1             : 37,
                debug_variable2             : 38,
                debug_variable3             : 39,
            }),
