...
export default class Debug
{
    constructor()
    {
        ...
        this.parent = this.experience.debug
    ...
    setGui()
    {
        this.ui = this.parent.ui.addFolder('MPRViewer').open()
    }
    ...
    setControllersDebugging()
    {
        ...
        this.controllers.debugging = 
        {
            option: folder.add(uniforms, 'option').options({ 
                ...
                voxel_intersected       : 301,
                voxel_terminated        : 302,
                voxel_coords            : 303,
                voxel_coords_step       : 304,
                voxel_max_position      : 305,
                voxel_min_position      : 306,
                voxel_entry_distance    : 307,
                voxel_exit_distance     : 308,
                voxel_span_distance     : 309,

                block_intersected       : 351,
                block_terminated        : 352,
                block_cheby_distance    : 353,
                block_coords            : 354,
                block_coords_step       : 355,
                block_max_position      : 356,
                block_min_position      : 357,
                block_entry_distance    : 358,
                block_exit_distance     : 359,
                block_span_distance     : 360,
