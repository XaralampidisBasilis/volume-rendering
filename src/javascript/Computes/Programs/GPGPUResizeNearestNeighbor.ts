...
export class GPGPUResizeNearestNeighbor implements GPGPUProgram 
{
    variableNames = ['Input']
    outputShape: number[]
    userCode: string
...
): tf.Tensor 
{
    ...
    const program = new GPGPUResizeNearestNeighbor(inputTensor.shape, outputShape, alignCorners, halfPixelCenters);
