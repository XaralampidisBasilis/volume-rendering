...
%% compute derivatives
P0_x = simplify(subs(P0_x, [a0 a1 a2 b2], [sol.a0, sol.a1, sol.a2, sol.b2]));
P1_x = simplify(subs(P1_x, [a0 a1 a2 b2], [sol.a0, sol.a1, sol.a2, sol.b2]));
P2_x = simplify(subs(P2_x, [a0 a1 a2 b2], [sol.a0, sol.a1, sol.a2, sol.b2]));
P3_x = simplify(subs(P3_x, [a0 a1 a2 b2], [sol.a0, sol.a1, sol.a2, sol.b2]));
N0_x = simplify(subs(N0_x, [a0 a1 a2 b2], [sol.a0, sol.a1, sol.a2, sol.b2]));
N1_x = simplify(subs(N1_x, [a0 a1 a2 b2], [sol.a0, sol.a1, sol.a2, sol.b2]));
N2_x = simplify(subs(N2_x, [a0 a1 a2 b2], [sol.a0, sol.a1, sol.a2, sol.b2]));
N3_x = simplify(subs(N3_x, [a0 a1 a2 b2], [sol.a0, sol.a1, sol.a2, sol.b2]));
D0_x = simplify(subs(D0_x, [a0 a1 a2 b2], [sol.a0, sol.a1, sol.a2, sol.b2]));
D1_x = simplify(subs(D1_x, [a0 a1 a2 b2], [sol.a0, sol.a1, sol.a2, sol.b2]));
D2_x = simplify(subs(D2_x, [a0 a1 a2 b2], [sol.a0, sol.a1, sol.a2, sol.b2]));
D3_x = simplify(subs(D3_x, [a0 a1 a2 b2], [sol.a0, sol.a1, sol.a2, sol.b2]));

%% Explore roots

[N_x, D_x] = numden(P0_x);
b1_x = simplify(solve(D_x == 0, b1));
x_b1 = simplify(solve(D_x == 0,  x));

D_coeffs = coeffs(D_x / (x0 - x1), x);
D_discrim = simplify(D_coeffs(2)^2 - 4 * D_coeffs(1) * D_coeffs(3));
b1_discrim = solve(D_discrim == 0, b1);
...
% rerwite
N21_D01_R = 2.0 * (g10*g11 + slope * (g10 + g11))/ (dx*g10);
D11_D01_R = (g10 + g11) / (dx*g10);

disp(simplify(subs(simplify(N21_D01 - N21_D01_R), [dx, slope, g10, g11], [x1 - x0, (f01 - f00) / (x1 - x0), f10 - (f01 - f00) / (x1 - x0), f11 - (f01 - f00) / (x1 - x0)])));
disp(simplify(subs(simplify(N21_D01 - N21_D01_R), [dx, slope, g10, g11], [x1 - x0, (f01 - f00) / (x1 - x0), f10 - (f01 - f00) / (x1 - x0), f11 - (f01 - f00) / (x1 - x0)])));

% or directly
P21_R2 = -2 * g11^2 / (dx*g10);
P21_R2 = 6 * g11^2 * (g10 + g11) / (dx*g10)^2;
